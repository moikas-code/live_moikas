  ...
  return (
    <>
      ...
      <footer className="w-full mt-12 py-6 flex flex-col items-center bg-base-100 rounded-lg shadow-inner">
        <span className="text-base-content/60 text-sm mb-2">&copy; {new Date().getFullYear()} live.moikas</span>
        {/* Mobile action buttons: flex on mobile, hidden on md+ */}
        <div className="flex flex-col gap-2 w-full px-4 md:hidden">
          <a
            href="/join"
            className="btn btn-accent btn-xs font-semibold w-full"
          >
            Join
          </a>
          <a
        ...
        <div className="hidden md:flex gap-2">
          <a
            href="/join"
            className="btn btn-accent btn-xs font-semibold"
          >
            Join
          </a>
          <a
